...
<div id="content-header">
	<h1>Edit Event Details Image</h1>
</div>
		...
		<div class="span12">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form action="<?php echo base_url();?>event/update_event_details_image/<?php echo $this->uri->segment(3);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<p><img src="<?php echo base_url(); ?>uploads/event_details_image/thumb/<?php echo $data['image']; ?>" alt="" /><br/><a href="<?php echo base_url(); ?>uploads/event_details_image/<?php echo $data['image']; ?>" target="_blank">view large size</a></p>
								<?php } ?>
